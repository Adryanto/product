...
import 'package:product/screens/input.dart';

class outputProduct extends StatelessWidget {
        ...
        children: [
          Expanded(
            child: StreamBuilder<Map<String, String>>(
              stream: _productServices.getProductList(),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            _productServices.removeProductItem(key);
                          },
                        ),
                      );
                    },
